      ...
      <View style={styles.container}>
        ...
        <View>
          <View style={{flexDirection: "row", justifyContent: "space-between",}}>
            <CalcButton onPress={this.onClearPress} title="AC" color="white" backgroundColor="#2097be" />
            <CalcButton onPress={this.onPlusMinusPress} title="+/-" color="white" backgroundColor="#2097be" />
            <CalcButton onPress={() => { this.onUnaryOperatorPress(this.oc.PercentOperator) }} title="%" color="white" backgroundColor="#2097be" />
            <CalcButton onPress={() => { this.onBinaryOperatorPress(this.oc.DivisionOperator) }} title="/" color="white" backgroundColor="#2097be" />
          </View>
          ...
          <View style={{flexDirection: "row", justifyContent: "space-between",}}>
            ...
            <CalcButton onPress={() => { this.onBinaryOperatorPress(this.oc.MultiplicationOperator) }} title="x" color="white" backgroundColor="#2097be" />
          </View>
          ...
          <View style={{flexDirection: "row", justifyContent: "space-between",}}>
            ...
            <CalcButton onPress={() => { this.onBinaryOperatorPress(this.oc.SubtractionOperator) }} title="-" color="white" backgroundColor="#2097be" />
          </View>
          ...
          <View style={{flexDirection: "row", justifyContent: "space-between",}}>
            ...
            <CalcButton onPress={() => { this.onBinaryOperatorPress(this.oc.AdditionOperator) }} title="+" color="white" backgroundColor="#2097be" />
          </View>
          ...
          <View style={{flexDirection: "row", justifyContent: "space-between",}}>
            ...
            <CalcButton onPress={this.onEqualsPress} title="=" color="white" backgroundColor="#2097be" />
          </View>
        </View>
